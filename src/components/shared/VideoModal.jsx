...
const VideoModal = ({ isOpen, onClose, videoUrl, title }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="relative w-full md:h-[85vh] bg-black rounded-[32px] overflow-hidden shadow-[0_0_120px_rgba(0,0,0,0.9)] border border-white/10 animate-in zoom-in-95 duration-300 flex flex-col group/modal"
        style={{ 
          maxWidth: videoMeta ? `min(95vw, calc(85vh * ${videoMeta.aspect}))` : '1152px' 
        }}
